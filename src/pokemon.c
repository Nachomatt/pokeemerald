...
s32 CalculateBaseDamage(struct BattlePokemon *attacker, struct BattlePokemon *defender, u32 move, u16 sideStatus, u16 powerOverride, u8 typeOverride, u8 battlerIdAtk, u8 battlerIdDef)
{
    ...
    if (attacker->ability == ABILITY_MINUS && ABILITY_ON_FIELD2(ABILITY_PLUS))
        spAttack = (150 * spAttack) / 100;
    if (attacker->ability == ABILITY_ROYAL_WRATH && ABILITY_ON_FIELD2(ABILITY_ROYAL_GUARD))
        attack = (150 * attack) / 100;
    if (defender->ability == ABILITY_ROYAL_GUARD && ABILITY_ON_FIELD2(ABILITY_ROYAL_WRATH))
...
struct MonSpritesGfxManager *CreateMonSpritesGfxManager(void)
{
    ...
    gfx->spriteBuffer = AllocZeroed(MON_PIC_SIZE * MAX_MON_PIC_FRAMES * gfx->numSprites);
