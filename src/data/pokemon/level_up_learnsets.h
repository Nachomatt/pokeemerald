...
static const u16 sMightyenaLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SHADOW_BALL), //Make Elemental Fang moves?
    LEVEL_UP_MOVE( 1, MOVE_EXTRASENSORY),
    LEVEL_UP_MOVE( 1, MOVE_SLACK_OFF),
    LEVEL_UP_MOVE( 1, MOVE_BEAT_UP), //Change to Maul, dark type multi hit move
...
static const u16 sZigzagoonLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(40, MOVE_HYDRO_PUMP),
    LEVEL_UP_MOVE(79, MOVE_BELLY_DRUM),
    LEVEL_UP_MOVE(100, MOVE_EXTREME_SPEED),
    LEVEL_UP_END
};

static const u16 sLinooneLevelUpLearnset[] = {
    LEVEL_UP_MOVE(1, MOVE_SHADOW_BALL),
    LEVEL_UP_MOVE(1, MOVE_BUBBLE), //Make Bubble into Aqua Jet
    LEVEL_UP_MOVE(1, MOVE_THUNDERBOLT),
    ...
    LEVEL_UP_MOVE(31, MOVE_FURY_SWIPES),
    LEVEL_UP_MOVE(37, MOVE_BUBBLE_BEAM), //Make into fun multi hit move?
    LEVEL_UP_MOVE(43, MOVE_ICE_BEAM),
    LEVEL_UP_MOVE(51, MOVE_HYDRO_PUMP),
    LEVEL_UP_MOVE(85, MOVE_BELLY_DRUM),
    LEVEL_UP_END
};
