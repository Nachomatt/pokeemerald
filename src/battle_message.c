...
static const u8 sText_PkmnBadlyPoisonedBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\n badly poisoned {B_EFF_NAME_WITH_PREFIX}!");
...
static const u8 sText_TricksterActivates[] = _("{B_DEF_NAME_WITH_PREFIX} thinks {B_ATK_NAME_WITH_PREFIX} should\ndo this instead!");
...
static const u8 sText_PkmnCursedBody[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\ndisabled {B_ATK_NAME_WITH_PREFIX}'s {B_CURRENT_MOVE}!");
static const u8 sText_GuardDogIntimidate[] = _("{B_DEF_NAME_WITH_PREFIX} is not impressed!\n{B_DEF_ABILITY} raises ATTACK!");
...
static const u8 sText_MasterMindActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} copied\n{B_BUFF1}'s stat changes!");
...
static const u8 sText_PkmnRaisedDefense[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nraised its DEFENSE!");
...
// static const u8 sText_StickyTrickyBlock[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_DEF_ABILITY}\nmade {B_SCR_ACTIVE_ABILITY} useless!");
...
static const u8 sText_PkmnPreventsRomanceWith[] = _("{B_DEF_NAME_WITH_PREFIX} thinks we're better\noff as friends!");
static const u8 sText_Coldhearteddoesntcare[] = _("{B_DEF_NAME_WITH_PREFIX} doesn't care about\nyour cheap tricks!");
...
static const u8 sText_PkmnCutsDefWith[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\ncuts {B_DEF_NAME_WITH_PREFIX}'s DEFENSE!");
...
static const u8 sText_PkmnsXBlocksY3[] = _("{B_DEF_NAME_WITH_PREFIX} shrugs off {B_CURRENT_MOVE}\nwith its {B_DEF_ABILITY}!");
static const u8 sText_PkmnsXReflector[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} reduces damage\nwith {B_SCR_ACTIVE_ABILITY}!");
static const u8 sText_PkmnsXRoars[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} lets out a MIGHTY ROAR!");
...
static const u8 sText_PkmnsXMadeitHail[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nmade it hail!");
...
static const u8 sText_JuicerActivates[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s {B_LAST_ITEM}\nturned into yummy juice!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] =
{
    ...
    [STRINGID_CURSEDBODY - BATTLESTRINGS_TABLE_START] = sText_PkmnCursedBody,
    [STRINGID_GUARDDOGINTIMIDATE - BATTLESTRINGS_TABLE_START] = sText_GuardDogIntimidate,
    ...
    [STRINGID_MASTERMINDACTIVATES - BATTLESTRINGS_TABLE_START] = sText_MasterMindActivates,
    ...
    [STRINGID_PKMNRAISEDDEFENSE - BATTLESTRINGS_TABLE_START] = sText_PkmnRaisedDefense,
    ...
    [STRINGID_COLDHEARTEDDOESNTCARE - BATTLESTRINGS_TABLE_START] = sText_Coldhearteddoesntcare,
    ...
    [STRINGID_PKMNLETSOUTROAR - BATTLESTRINGS_TABLE_START] = sText_PkmnsXRoars,
    ...
    [STRINGID_PKMNSXBLOCKSY3 - BATTLESTRINGS_TABLE_START] = sText_PkmnsXBlocksY3,
...
const u16 gGotBadlyPoisonedStringIds[] =
{
