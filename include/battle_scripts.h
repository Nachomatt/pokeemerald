...
extern const u8 BattleScript_PresentHealTargetEnd3[];
...
extern const u8 BattleScript_MightyRoarActivates[];
extern const u8 BattleScript_MightyRoarActivatesEnd3[];
...
extern const u8 BattleScript_ColdheartedDoesntCare[];
...
extern const u8 BattleScript_ToughHideProtected[];
extern const u8 BattleScript_AbilityNoSpecificStatLoss[];
extern const u8 BattleScript_StickyHoldActivates[];
extern const u8 BattleScript_StickyHoldAbilityActivates[];
extern const u8 BattleScript_ColorChangeActivates[];
extern const u8 BattleScript_TricksterActivates[];
extern const u8 BattleScript_MagicBounceActivates[];
extern const u8 BattleScript_RoughSkinActivates[];
extern const u8 BattleScript_EffectCursedBody[];
